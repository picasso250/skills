#!/usr/bin/env python3
"""
Reuse the WeChat article-editor tab and click "去声明" from the publish dialog.
"""
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                if not box:
                    raise RuntimeError("Go declare button was found but had no bounding box.")
        ...
        logging.error("Failed while clicking go declare in the reused editor tab: %s", exc)
        sys.exit(1)
