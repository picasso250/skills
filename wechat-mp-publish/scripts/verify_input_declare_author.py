#!/usr/bin/env python3
"""
Reuse the declaration dialog and physically type into its author field.
"""
...
def main() -> None:
    ...
    try:
        ...
        logging.error("Failed while typing declaration author in the reused editor tab: %s", exc)
        sys.exit(1)
