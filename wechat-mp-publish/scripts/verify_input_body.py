#!/usr/bin/env python3
"""
Reuse the WeChat article-editor tab and physically type into the body editor.
"""
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                type_like_human(page, BODY_TEXT)
        ...
        logging.error("Failed while typing body in the reused editor tab: %s", exc)
        sys.exit(1)
